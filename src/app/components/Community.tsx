  ...
  return (
    <section className="bg-[#121212] h-screen w-full text-white py-16 flex flex-col items-center">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 h-[75%] max-w-5xl">
        {/* Developers */}
        <div className="bg-gradient-to-b from-[#121212] to-[#59429D] p-8 rounded-lg shadow-lg flex flex-col justify-around items-center text-center">
          ...
          <button className="bg-[#192041] text-white text-xl w-[80%] py-3 rounded-full hover:opacity-80">
            Learn more
          </button>
        </div>

        {/* Maintainers */}
        <div className="bg-gradient-to-b from-[#121212] to-[#7C429D] p-8 rounded-lg shadow-lg flex flex-col justify-around items-center text-center">
          ...
          <button className="bg-[#E1695B] w-[80%] text-xl text-white py-3 rounded-full hover:opacity-80">
            Learn more
          </button>
        </div>

        {/* Companies */}
        <div className="bg-gradient-to-b from-[#121212] to-[#E1695B] p-8 rounded-lg shadow-lg flex flex-col justify-around items-center text-center">
